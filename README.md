...
![Emergency Safety Classifier](media/screenshots/screenshot-1-emergency-classifier.png)

### 2. AED Learning Coach

PulsePrep explains AED concepts in age-appropriate language for a middle school audience.

![AED Learning Coach](media/screenshots/screenshot-2-aed-learning-coach.png)
...
![Scenario Practice Quiz](media/screenshots/screenshot-3-scenario-quiz.png)
...
![AED Locator / Awareness Demo](media/screenshots/screenshot-4-aed-awareness-demo.png)

### 5. Emergency Facility Finder Demo

PulsePrep supports emergency facility awareness planning with strong safety limitations.

![Emergency Facility Finder Demo](media/screenshots/screenshot-5-emergency-facility-finder.png)
...
![Outreach Generator](media/screenshots/screenshot-6-outreach-generator.png)

### 7. About / Project Overview

The About page explains the project purpose, agent architecture, tool layer, and safety limitations.

![About / Project Overview](media/screenshots/screenshot-7-about-architecture.png)
